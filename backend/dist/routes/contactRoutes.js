...
const ImportChatsContactsController = __importStar(require("../controllers/ImportChatsContactsController"));
...
contactRoutes.post("/contacts/import/chats", isAuth_1.default, ImportChatsContactsController.store);
...
contactRoutes.delete("/contacts/batch-delete", isAuth_1.default, ContactController.bulkRemove); // <-- MOVA ESTA LINHA PARA CIMA
contactRoutes.delete("/contacts/:contactId", isAuth_1.default, ContactController.remove); // <-- DEIXE ESTA LINHA ABAIXO
...
contactRoutes.put("/contacts/toggleTranslate/:contactId", isAuth_1.default, ContactController.toggleContactTranslate);
contactRoutes.put("/contact-wallet/:contactId", isAuth_1.default, ContactController.updateContactWallet);
contactRoutes.post("/contacts/:contactId/products", isAuth_1.default, ContactController.addProduct);
contactRoutes.put("/contacts/:contactId/products/:productId", isAuth_1.default, ContactController.updateProduct);
contactRoutes.delete("/contacts/:contactId/products/:productId", isAuth_1.default, ContactController.removeProduct);
