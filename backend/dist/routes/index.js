...
const whatsappCloudRoutes_1 = __importDefault(require("./whatsappCloudRoutes"));
const whatsappCloudWebhookRoutes_1 = __importDefault(require("./whatsappCloudWebhookRoutes"));
...
routes.use("/api", whatsappCloudRoutes_1.default);
routes.use("/api", whatsappCloudWebhookRoutes_1.default);
