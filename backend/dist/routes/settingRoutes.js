...
// Currency routes - MUST be before generic :settingKey routes
settingRoutes.get("/settings/currency", isAuth_1.default, SettingController.getCurrency);
settingRoutes.put("/settings/currency", isAuth_1.default, isSuper_1.default, SettingController.updateCurrency);
// Timezone routes - MUST be before generic :settingKey routes
settingRoutes.get("/settings/timezones", isAuth_1.default, SettingController.getAvailableTimezones);
settingRoutes.put("/settings/default-timezone", isAuth_1.default, isSuper_1.default, SettingController.updateDefaultTimezone);
settingRoutes.put("/settings/company-timezone", isAuth_1.default, SettingController.updateCompanyTimezone);
