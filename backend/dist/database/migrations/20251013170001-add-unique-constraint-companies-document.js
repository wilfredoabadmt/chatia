...
module.exports = {
    ...
    `);
        if (duplicates.length > 0) {
            ...
            throw new Error(`Cannot create UNIQUE constraint: ${duplicates.length} duplicate document(s) found. ` +
    ...
    `);
        ...
        const [uniqueCount] = await queryInterface.sequelize.query(`
    ...
    `);
        ...
        try {
            const [explainResult] = await queryInterface.sequelize.query(`
        EXPLAIN (FORMAT JSON)
