...
module.exports = {
        ...
        if (duplicates.length > 0) {
            ...
            for (const dup of duplicates) {
                ...
                if (idsToDelete.length > 0) {
                    ...
                    const [companiesToDelete] = await queryInterface.sequelize.query(`
    ...
    `);
        if (remainingDuplicates.length > 0) {
            ...
            throw new Error(`Data integrity check failed: ${remainingDuplicates.length} duplicate(s) still exist. ` +
