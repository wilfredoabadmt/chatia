...
exports.showCurrent = exports.indexPlan = exports.listPlan = exports.remove = exports.updateSchedules = exports.update = exports.list = exports.show = exports.store = exports.index = void 0;
...
const store = async (req, res) => {
    ...
    const schema = Yup.object().shape({
        ...
        document: Yup.string()
            ...
            if (!value || value.trim() === '')
                return null;
            return (0, DocumentValidator_1.normalizeDocument)(value);
        })
            ...
            if (!value)
                return true;
            return (0, DocumentValidator_1.validateCPFOrCNPJ)(value);
        })
    });
    try {
