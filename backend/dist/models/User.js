    ...
    (0, sequelize_typescript_1.Column)({
        ...
        set(value) {
            if (value === "" || value === 0) {
                ...
                this.setDataValue('whatsappId', null);
            }
            else {
                // Correção Final: Use a asserção 'as any'
                this.setDataValue('whatsappId', value);
            }
        }
    }),
    __metadata("design:type", Number)
...
__decorate([
    ...
    __metadata("design:type", Boolean)
], User.prototype, "canViewAllContacts", void 0);
__decorate([
...
__decorate([
    (0, sequelize_typescript_1.Default)("pt-BR"),
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING),
    __metadata("design:type", String)
], User.prototype, "language", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING(64)) // Added for password reset token
    ,
    __metadata("design:type", String)
], User.prototype, "passwordResetToken", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.DATE) // Added for password reset expiration
    ,
    __metadata("design:type", Date)
