...
settingRoutes.get("/settings/currency", isAuth, SettingController.getCurrency);
settingRoutes.put("/settings/currency", isAuth, isSuper, SettingController.updateCurrency);

// Timezone routes - MUST be before generic :settingKey routes
settingRoutes.get("/settings/timezones", isAuth, SettingController.getAvailableTimezones);
settingRoutes.put("/settings/default-timezone", isAuth, isSuper, SettingController.updateDefaultTimezone);
settingRoutes.put("/settings/company-timezone", isAuth, SettingController.updateCompanyTimezone);
