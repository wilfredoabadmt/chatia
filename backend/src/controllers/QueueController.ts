...
export const store = async (req: Request, res: Response): Promise<Response> => {
  ...
  const queue = await CreateQueueService({
    ...
    companyId,
    outOfHoursMessage, 
    tempoRoteador: tempoRoteador === "" || tempoRoteador === null || tempoRoteador === undefined ? 0 : tempoRoteador, 
    ativarRoteador: ativarRoteador === "" || ativarRoteador === null || ativarRoteador === undefined ? false : ativarRoteador,
    schedules,
    chatbots, 
