"use strict";
(self["webpackChunkfrontend"] = self["webpackChunkfrontend"] || []).push([[5526],{
...
var NumberFormat = /*@__PURE__*/function (superclass) {
  ...
  NumberFormat.prototype.render = function render() {
    ...
    if (displayType === 'text') {
      return renderText ? renderText(value, otherProps) || null : react__WEBPACK_IMPORTED_MODULE_0__.createElement('span', Object.assign({}, otherProps, {
        ref: getInputRef
      }), value);
    } else if (customInput) {
