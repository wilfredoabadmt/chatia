"use strict";
(self["webpackChunkfrontend"] = self["webpackChunkfrontend"] || []).push([[1990],{
...
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(63731);
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28073);
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(66795);
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(51575);
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(61531);
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(66187);
...
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(77925);
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(18073);
/* harmony import */ var _material_ui_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(8289);
/* harmony import */ var _material_ui_core_styles__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(81551);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(65043);
/* harmony import */ var react_i18next__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(74117);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(62582);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(91688);
/* harmony import */ var react_toastify__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(43550);
/* harmony import */ var _errors_toastError__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(82455);
/* harmony import */ var _services_api__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(94505);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(70579);
const useStyles=(0,_material_ui_core_styles__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A)(theme=>({root:{minHeight:"100vh",background:"linear-gradient(120deg, ".concat(theme.palette.primary.main," 0%, ").concat(theme.palette.primary.main," 100%)"),display:"flex",alignItems:"center",justifyContent:"center",position:"relative",overflow:"hidden","&:before":{content:'""',position:"absolute",top:"-50%",left:"-50%",width:"200%",height:"200%",background:"radial-gradient(circle, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0) 80%)",animation:"pulse 15s infinite"}},container:{position:"relative",zIndex:1},formBox:{background:"rgba(255, 255, 255, 0.95)",borderRadius:"24px",padding:theme.spacing(4),boxShadow:"0 15px 35px rgba(0, 0, 0, 0.2)",backdropFilter:"blur(10px)",border:"1px solid rgba(65, 22, 22, 0.3)",maxWidth:"400px",width:"100%",animation:"float 3s ease-in-out infinite"},title:{color:theme.palette.primary.dark,fontWeight:700,marginBottom:theme.spacing(3),textAlign:"center",background:"linear-gradient(45deg, ".concat(theme.palette.primary.main,", ").concat(theme.palette.primary.main,")"),WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"},form:{width:"100%"},textField:{"& .MuiOutlinedInput-root":{borderRadius:"12px",transition:"all 0.3s","&:hover":{boxShadow:"0 0 15px rgba(22, 13, 3, 0.3)"},"&.Mui-focused":{boxShadow:"0 0 20px rgba(20, 20, 19, 0.5)"}},marginBottom:theme.spacing(2)},submitButton:{margin:theme.spacing(3,0,2),padding:theme.spacing(1.5),borderRadius:"12px",background:"linear-gradient(45deg, ".concat(theme.palette.primary.main,", ").concat(theme.palette.primary.main,")"),textTransform:"none",fontWeight:600,fontSize:"1.1rem",position:"relative",overflow:"hidden",transition:"all 0.3s","&:hover":{transform:"scale(1.05)",boxShadow:"0 8px 25px rgba(19, 18, 18, 0.4)"}},loadingBar:{position:"absolute",bottom:0,left:0,width:"100%",height:"4px","& .MuiLinearProgress-bar":{background:"rgba(255, 255, 255, 0.8)"}},sentAnimation:{position:"relative",background:"linear-gradient(45deg, #4caf50, #81c784)","&:after":{content:'"✉️"',position:"absolute",fontSize:"24px",top:"50%",left:"50%",transform:"translate(-50%, -50%)",animation:"flyAway 1s ease-out forwards"}},link:{color:theme.palette.grey[700],textDecoration:"none",transition:"all 0.3s","&:hover":{color:"#0d120f",transform:"translateX(5px)"}},errorText:{color:theme.palette.error.main,textAlign:"center",marginBottom:theme.spacing(2)},"@keyframes float":{"0%, 100%":{transform:"translateY(0)"},"50%":{transform:"translateY(-10px)"}},"@keyframes pulse":{"0%, 100%":{transform:"scale(1)"},"50%":{transform:"scale(1.1)"}},"@keyframes flyAway":{"0%":{transform:"translate(-50%, -50%) scale(1)",opacity:1},"100%":{transform:"translate(-50%, -150%) scale(0.5)",opacity:0}}}));const RedefinirSenha=()=>{const classes=useStyles();const location=(0,react_router_dom__WEBPACK_IMPORTED_MODULE_16__.useLocation)();const history=(0,react_router_dom__WEBPACK_IMPORTED_MODULE_16__.useHistory)();const _useTranslation=(0,react_i18next__WEBPACK_IMPORTED_MODULE_14__/* .useTranslation */ .Bd)(),t=_useTranslation.t;const token=new URLSearchParams(location.search).get("token");const _useState=(0,react__WEBPACK_IMPORTED_MODULE_13__.useState)(""),_useState2=(0,D_Documentos_GitHub_ChatIA_frontend_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_useState,2),senha=_useState2[0],setSenha=_useState2[1];const _useState3=(0,react__WEBPACK_IMPORTED_MODULE_13__.useState)(""),_useState4=(0,D_Documentos_GitHub_ChatIA_frontend_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_useState3,2),confirmarSenha=_useState4[0],setConfirmarSenha=_useState4[1];const _useState5=(0,react__WEBPACK_IMPORTED_MODULE_13__.useState)(false),_useState6=(0,D_Documentos_GitHub_ChatIA_frontend_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_useState5,2),enviando=_useState6[0],setEnviando=_useState6[1];const _useState7=(0,react__WEBPACK_IMPORTED_MODULE_13__.useState)(false),_useState8=(0,D_Documentos_GitHub_ChatIA_frontend_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_useState7,2),enviado=_useState8[0],setEnviado=_useState8[1];const _useState9=(0,react__WEBPACK_IMPORTED_MODULE_13__.useState)(false),_useState0=(0,D_Documentos_GitHub_ChatIA_frontend_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_useState9,2),visivel=_useState0[0],setVisivel=_useState0[1];const _useState1=(0,react__WEBPACK_IMPORTED_MODULE_13__.useState)(""),_useState10=(0,D_Documentos_GitHub_ChatIA_frontend_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_useState1,2),error=_useState10[0],setError=_useState10[1];(0,react__WEBPACK_IMPORTED_MODULE_13__.useEffect)(()=>{setVisivel(true);if(!token){setError(t("resetPassword.errors.invalidToken"));console.error("No token found in URL:",location.search);}else{console.log("Token extracted from URL:",token);}},[token,location.search]);const handleSubmit=async e=>{e.preventDefault();setError("");if(senha!==confirmarSenha){react_toastify__WEBPACK_IMPORTED_MODULE_17__/* .toast */ .oR.error(t("resetPassword.toasts.passwordMismatch"));setError(t("resetPassword.errors.passwordMismatch"));return;}if(senha.length<6){react_toastify__WEBPACK_IMPORTED_MODULE_17__/* .toast */ .oR.error(t("resetPassword.toasts.passwordTooShort"));setError(t("resetPassword.errors.passwordTooShort"));return;}setEnviando(true);try{await _services_api__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .Ay.post("/auth/reset-password",{token,newPassword:senha});setEnviando(false);setEnviado(true);react_toastify__WEBPACK_IMPORTED_MODULE_17__/* .toast */ .oR.success(t("resetPassword.toasts.success"));setTimeout(()=>{setEnviado(false);history.push("/login");},2000);}catch(err){var _err$response,_err$response$data;setEnviando(false);const errorMessage=((_err$response=err.response)===null||_err$response===void 0?void 0:(_err$response$data=_err$response.data)===null||_err$response$data===void 0?void 0:_err$response$data.message)||t("resetPassword.errors.resetError");setError(errorMessage);(0,_errors_toastError__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .A)(err);}};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsxs)("div",{className:classes.root,children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Ay,{}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{in:visivel,timeout:1000,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A,{className:classes.container,maxWidth:"xs",children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A,{in:visivel,timeout:1200,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsxs)(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A,{className:classes.formBox,children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A,{variant:"h4",className:classes.title,children:t("resetPassword.title")}),error&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A,{className:classes.errorText,children:error}),!error&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsxs)("form",{className:classes.form,noValidate:true,onSubmit:handleSubmit,children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A,{variant:"outlined",required:true,fullWidth:true,name:"senha",label:t("resetPassword.form.newPassword"),type:"password",id:"senha",autoComplete:"new-password",value:senha,onChange:e=>setSenha(e.target.value),className:classes.textField,disabled:enviando||enviado}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A,{variant:"outlined",required:true,fullWidth:true,name:"confirmarSenha",label:t("resetPassword.form.confirmPassword"),type:"password",id:"confirmarSenha",autoComplete:"new-password",value:confirmarSenha,onChange:e=>setConfirmarSenha(e.target.value),className:classes.textField,disabled:enviando||enviado}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsxs)(_material_ui_core__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A,{type:"submit",fullWidth:true,variant:"contained",color:"primary",className:"".concat(classes.submitButton," ").concat(enviado?classes.sentAnimation:""),disabled:enviando||enviado||!token,children:[enviando?t("resetPassword.buttons.submitting"):enviado?t("resetPassword.buttons.submitted"):t("resetPassword.buttons.submit"),enviando&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A,{className:classes.loadingBar})]}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .A,{container:true,justifyContent:"center",children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .A,{item:true,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_material_ui_core__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .A,{component:react_router_dom__WEBPACK_IMPORTED_MODULE_15__/* .Link */ .N_,to:"/login",className:classes.link,children:t("resetPassword.buttons.backToLogin")})})})]})]})})})})]});};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (RedefinirSenha);
...
/* harmony import */ var react_transition_group__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(88692);
/* harmony import */ var _styles_transitions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(12899);
/* harmony import */ var _styles_useTheme__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(70567);
/* harmony import */ var _transitions_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(40830);
/* harmony import */ var _utils_useForkRef__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(60768);
...
var defaultTimeout = {
  enter: _styles_transitions__WEBPACK_IMPORTED_MODULE_5__/* .duration */ .p0.enteringScreen,
  exit: _styles_transitions__WEBPACK_IMPORTED_MODULE_5__/* .duration */ .p0.leavingScreen
};
/**
...
var Fade = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.forwardRef(function Fade(props, ref) {
  var children = props.children,
    ...
    TransitionComponent = _props$TransitionComp === void 0 ? react_transition_group__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Ay : _props$TransitionComp,
    _props$timeout = props.timeout,
    timeout = _props$timeout === void 0 ? defaultTimeout : _props$timeout,
    other = (0,_babel_runtime_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(props, ["children", "disableStrictModeCompat", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "TransitionComponent", "timeout"]);
  var theme = (0,_styles_useTheme__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)();
  var enableStrictModeCompat = theme.unstable_strictMode && !disableStrictModeCompat;
  var nodeRef = react__WEBPACK_IMPORTED_MODULE_3__.useRef(null);
  var foreignRef = (0,_utils_useForkRef__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)(children.ref, ref);
  var handleRef = (0,_utils_useForkRef__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)(enableStrictModeCompat ? nodeRef : undefined, foreignRef);
  var normalizedTransitionCallback = function normalizedTransitionCallback(callback) {
    return function (nodeOrAppearing, maybeAppearing) {
      if (callback) {
        var _ref = enableStrictModeCompat ? [nodeRef.current, nodeOrAppearing] : [nodeOrAppearing, maybeAppearing],
          _ref2 = (0,_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(_ref, 2),
          node = _ref2[0],
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(TransitionComponent, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)({
    appear: true,
    in: inProp,
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.cloneElement(children, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)({
