			...
			{loading ? (
				...
				<div className={classes.content}>
					<Paper square variant="outlined" className={classes.contactHeader}>
						...
						>
							{checkBlockedList() ? i18n.t("contactDrawer.buttons.unblockContact") : i18n.t("contactDrawer.buttons.blockContact")}
						</Button>
					</Paper>
					<Paper square variant="outlined" className={classes.contactDetails}>
						<ConfirmationModal
        					title={checkBlockedList() ? i18n.t("contactDrawer.buttons.unblockContact") : i18n.t("contactDrawer.buttons.blockContact")}
        					open={blockModalOpen}
